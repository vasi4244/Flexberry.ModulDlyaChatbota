...
moduleForModel('i-i-s-modul-dlya-chatbota-содержание', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-содержание', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-содержание',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
