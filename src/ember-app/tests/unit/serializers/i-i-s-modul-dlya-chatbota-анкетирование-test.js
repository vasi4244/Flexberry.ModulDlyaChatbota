...
moduleForModel('i-i-s-modul-dlya-chatbota-анкетирование', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-анкетирование', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-анкетирование',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
