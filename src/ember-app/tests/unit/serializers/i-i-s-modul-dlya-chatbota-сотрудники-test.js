...
moduleForModel('i-i-s-modul-dlya-chatbota-сотрудники', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
