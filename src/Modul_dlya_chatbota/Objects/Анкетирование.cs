...
namespace IIS.Modul_dlya_chatbota
{
    ...
    public class Анкетирование : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota.DetailArrayOfСписок fСписок;
        ...
        public virtual IIS.Modul_dlya_chatbota.DetailArrayOfСписок Список
        {
            get
            {
                ...
                {
                    this.fСписок = new IIS.Modul_dlya_chatbota.DetailArrayOfСписок(this);
                }
                IIS.Modul_dlya_chatbota.DetailArrayOfСписок result = this.fСписок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АнкетированиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетированиеE", typeof(IIS.Modul_dlya_chatbota.Анкетирование));
                }
            }
            ...
            public static ICSSoft.STORMNET.View АнкетированиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетированиеL", typeof(IIS.Modul_dlya_chatbota.Анкетирование));
                }
            }
        }
    }
