...
namespace IIS.Modul_dlya_chatbota
{
    ...
    public class НастройкаОпр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota.Опрос fОпрос;
        
        private IIS.Modul_dlya_chatbota.Сотрудники fСотрудники;
        
        private IIS.Modul_dlya_chatbota.DetailArrayOfСодержание fСодержание;
        ...
        [PropertyStorage(new string[] {
                "Опрос"})]
        [NotNull()]
        public virtual IIS.Modul_dlya_chatbota.Опрос Опрос
        {
            get
            {
                ...
                IIS.Modul_dlya_chatbota.Опрос result = this.fОпрос;
        ...
        public virtual IIS.Modul_dlya_chatbota.DetailArrayOfСодержание Содержание
        {
            get
            {
                ...
                {
                    this.fСодержание = new IIS.Modul_dlya_chatbota.DetailArrayOfСодержание(this);
                }
                IIS.Modul_dlya_chatbota.DetailArrayOfСодержание result = this.fСодержание;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НастройкаОпрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НастройкаОпрE", typeof(IIS.Modul_dlya_chatbota.НастройкаОпр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НастройкаОпрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НастройкаОпрL", typeof(IIS.Modul_dlya_chatbota.НастройкаОпр));
                }
            }
        }
    }
