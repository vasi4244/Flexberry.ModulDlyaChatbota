...
namespace IIS.Modul_dlya_chatbota
{
    ...
    [View("СотрудникиE", new string[] {
            ...
            "Отдел as \'Отдел\'",
            "Отдел.Наименование as \'Наименование\'"}, Hidden=new string[] {
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota.Должность fДолжность;
        
        private IIS.Modul_dlya_chatbota.Отдел fОтдел;
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.Modul_dlya_chatbota.Должность Должность
        {
            get
            {
                ...
                IIS.Modul_dlya_chatbota.Должность result = this.fДолжность;
        ...
        [PropertyStorage(new string[] {
                "Отдел"})]
        [NotNull()]
        public virtual IIS.Modul_dlya_chatbota.Отдел Отдел
        {
            get
            {
                ...
                IIS.Modul_dlya_chatbota.Отдел result = this.fОтдел;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Modul_dlya_chatbota.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Modul_dlya_chatbota.Сотрудники));
                }
            }
        }
    }
